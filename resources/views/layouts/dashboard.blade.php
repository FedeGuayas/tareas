                ...
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        @if (Auth::user()->hasRole(['supervisor', 'administrador']))
                            <li>
                                <a href="#"><i class="fa fa-files-o" aria-hidden="true"></i> Reportes<span
                            ...
                            <li>
                                <a href="#"><i class="fa fa-cogs" aria-hidden="true"></i> Gestión<span
                                            class="fa arrow"></span></a>
                                <ul class="nav nav-second-level">
                                    <li>
                                    ...
                                    <li>
                                        <a href="#"><i class="fa fa-users" aria-hidden="true"></i> Trabajadores <span
                                                    class="fa arrow"></span></a>
                                        <ul class="nav nav-third-level">
                                            <li>
                                    ...
                                    <li>
                                        <a href="#"><i class="fa fa-tasks" aria-hidden="true"></i> Tareas<span
                                                    class="fa arrow"></span></a>
                                        <ul class="nav nav-third-level">
                                            <li>
                                            ...
                                            <li>
                                                <a href="{{route('admin.calendar.edit')}}"><i
                                                            class="fa fa-calendar fa-fw"></i> Calendario</a>
                                            </li>
                                        </ul>
                                        <!-- /.nav-third-level -->
                                    </li>
                        ...
                        @role('administrador')
                        <li>
                            <a href="#"><i class="fa fa-lock fa-fw" aria-hidden="true"></i> Administración<span
                                        class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="{{route('admin.users.index')}}"><i class="fa fa-user-secret fa-fw"
                                                                                aria-hidden="true"></i> Accesos Usuarios
                                ...
                                <li>
                                    ...
                                    <a href="#"><i class="fa fa-key fa-fw" aria-hidden="true"></i>Admin<span
                                                class="fa arrow"></span></a>
                                    <ul class="nav nav-third-level">
                                        <li>
