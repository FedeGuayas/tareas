...
@section('page_heading','Adm. de Tareas')
                            ...
                            <div class="box box-solid">
                                ...
                                <div class="box-body">
                                    ...
                                    <div id="external-events">
                                        <div class="external-event ">Tarea 1</div>
                                        <div class="external-event bg-yellow">Tarea 2</div>
                                        <div class="external-event bg-aqua">Tarea 3</div>
                                        <div class="external-event bg-light-blue">Tarea 4</div>
                                        <div class="checkbox">
                            ...
                            <div class="box box-solid">
                                ...
                                <div class="box-body">
                                    ...
                                    <div class="input-group">
                                        <input id="new-event" type="text" class="form-control" placeholder="Titulo de la Tarea">
                                    ...
                                    <!-- /input-group -->
                                    {!! Form::open(['route' => ['postTask'], 'method' => 'POST', 'id' =>'form-calendario']) !!}
                                    {!! Form::close() !!}
                                </div>
                            </div>
                        </div>
